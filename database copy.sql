...
( 'group1', '$2a$10$OsPuAKcp4ip.sb2zZUM9vuJwhoRdGdJVcbIlWobbX4XbFPcg8Zjey', 2),
( 'group2', '$2a$10$OsPuAKcp4ip.sb2zZUM9vuJwhoRdGdJVcbIlWobbX4XbFPcg8Zjey', 2),
...
(1, 2, 'group1', 'db bio', 'db website', 'db email', 'db phone', 'db street', 'db city', 'db state', 'db zipcode');

--  PROVIDER Dummy Data --
INSERT INTO "provider" ( "user_id", "name", "bio", "picture","phone", "email", "insurance_id", "occupation_id", "specialization_id", "service_id", "availability", "group_id") VALUES
(4, 
'Provier 1 Name', 
'My bio',
 'https://static.wixstatic.com/media/3d076e_adb70c8b93b845f1b93d50028c5013e8~mv2.jpeg/v1/crop/x_0,y_727,w_1242,h_1173/fill/w_412,h_389,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/695BF34C-4BAC-4D41-85DD-95CE130DAA57%20-%20S.jpeg', 
